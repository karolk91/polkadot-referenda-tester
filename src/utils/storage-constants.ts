 ...
 * (additively, without modifying existing members) and funds the Alice account.
 *
 ...
 * IdToIndex/IndexToId/MemberCount voting maps are never read and remain unchanged.
 *
 * A superset of {@link ALICE_ACCOUNT_INJECTION} by construction, so a fork that requires both
 * (a shared governance + fellowship chain creating both kinds of referendum) can use this one.
 */
