 ...
 *
 * A superset of {@link ALICE_ACCOUNT_INJECTION} by construction, so a fork that needs both
 * (a shared governance + fellowship chain creating both kinds of referendum) can take this one.
 */
